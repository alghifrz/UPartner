...
<body class="bg-background">
    ...
    <div class="min-h-full z-20"> 
        ...
        <main class="relative"> 
            ...
            <div class="mx-4 md:mx-32 lg:mx-64 xl:ml-80 pt-8 md:pt-16 items-start mb-20 md:mb-36">
            ...
            <div class="mx-4 md:mx-32 lg:mx-64 xl:mr-80 pt-8 md:pt-16 items-start mb-20 md:mb-36">
            ...
            <div class="bg-secondary p-8 md:p-16 mb-20 md:mb-36">
                ...
                <div class="mx-4 md:mx-12 lg:mx-24 flex flex-wrap justify-center gap-8 md:gap-16">
