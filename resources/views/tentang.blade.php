    ...
    <div class="min-h-full z-20">
        ...
        <main class="relative">
            <div class="mt-32 mx-24 relative opacity-0 data-animate overflow-hidden" data-animation="slide-up">
                <div class="p-12 px-16 absolute top-0 left-40 z-20 bg-muda max-w-4xl rounded-3xl opacity-0 data-animate" data-animation="slide-up">
                ...
                <div class="p-12 absolute bottom-0 left-40 z-20 bg-primary max-w-4xl opacity-0 data-animate" data-animation="slide-up">
                ...
                <img src="{{ $tentang ['foto'] }}" alt="foto" width="100%" class="pt-40 z-10 rounded-t-3xl hover:cursor-pointer hover:scale-105 hover:duration-500">
            </div>
            <div class="mt-0 mx-24 p-24 py-12 bg-white text-secondary rounded-bl-3xl rounded-br-2xl opacity-0 data-animate" data-animation="slide-up">
              ...
              <div class="mt-32 mx-24">
                <h3 class="text-4xl font-bold mb-10 text-center">List of Authors</h3>
            
                <div class="flex justify-between gap-12 mb-12">
            
                  <x-cardauthor link="#" image="img/alghif.png" author="Alghif Rz" email="alghifarirasyidzola@gmail.com" />
                  <x-cardauthor link="#" author="Alghif Rz" email="alghifarirasyidzola@gmail.com" />
                  <x-cardauthor link="#" author="Alghif Rz" email="alghifarirasyidzola@gmail.com" />
                  <x-cardauthor link="#" author="Alghif Rz" email="alghifarirasyidzola@gmail.com" />
